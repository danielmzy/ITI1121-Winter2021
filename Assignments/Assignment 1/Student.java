...
public class Student extends Customer{
	...
	double SAVINGS_INTEREST = 0.07;
	double CHECK_INTEREST = 0.03;
	double CHECK_CHARGE = 0.02;
	double OVERDRAFT_PENALTY = 20.0;
	
	// constructor
	public Student (String name, int age, String customerNumber, String address, String telephoneNumber){
