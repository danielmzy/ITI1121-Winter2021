...
public class InformationGainCalculator {
	...
	public static GainInfoItem[] calculateAndSortInformationGains(VirtualDataSet dataset) {
		if (dataset == null) {
			throw new NullPointerException("The dataset array is null!!!");
		}

		int n = dataset.getNumberOfAttributes() - 1; // Minus 1 because we assume the last attribute is the class
														// (to
														// predict)
	...
	public static void main(String[] args) throws Exception {
		...
		String strFilename = "weather-nominal.csv";
		/// args[0];
